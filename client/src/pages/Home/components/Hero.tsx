...
const Hero: React.FC = () => {
  return (
    <div className="relative h-screen md:h-auto overflow-y-auto flex flex-col md:flex-row md:h-[44rem] md:pt-18">
      {/* Left side  */}
      <div className="flex-1 bg-gray-900 text-white flex items-center justify-center px-8 py-20 relative">
        ...
        <div className="space-y-10 max-w-md">
          ...
          <button className='border p-2 px-4 hover:bg-gray-800 rounded-lg'>Get Started</button>
        ...
        {/* Decorative elements */}
        <div className="absolute top-24 right-0 w-32 h-32 bg-[#FFD700] rounded-full opacity-30 filter blur-lg"></div>
